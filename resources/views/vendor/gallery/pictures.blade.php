                        ...
                        @if ($list->total() > 0)
                            ...
                            @foreach ($list as $item)
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>
                                        <a href="{{asset($item->image)}}" target="_blank" rel="noopener noreferrer">
                                            <img height="75" src="{{asset($item->image)}}" alt="">
                                        </a>
                                      </td>
                                    ...
                                    <td>
                                        <label class="switch s-icons s-outline  s-outline-warning  mb-4 mr-2">
                                            <input type="checkbox" class="change_status" data-id="{{ $item->id }}"data-url="{{ url('vendor/pictures/change_status') }}" @if ($item->active) checked @endif> <span class="slider round"></span>
                                        </label>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown custom-dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                                ...
                                                data-message="Do you want to remove this Picture?"
                                                href="{{ url('vendor/pictures/delete/' . $item->id) }}"><i
