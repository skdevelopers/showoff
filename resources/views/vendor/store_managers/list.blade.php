...
@section("content")
<div class="card mb-5">
    <div class="card-header"><a href="{{url('vendor/store_managers/create')}}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Role</a></div>
    <div class="card-body">
                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    href="{{ url('vendor/store_managers/' . $datarow->id) }}">

                                        <i class="flaticon-delete-1"></i> Delete </a>

                                    <a class="dropdown-item" href="{{ url('vendor/privilege?id='.encrypt($datarow->id) )}}"><i class="flaticon-pencil-1"></i> Privilege </a>
