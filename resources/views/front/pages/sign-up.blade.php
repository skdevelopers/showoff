        ...
        <div class="row g-4 g-xl-5 justify-content-between">
            <div class="col-xl-5 d-flex justify-content-center">
                <div class="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
                    <!-- Start Header Text -->
                    <div class="mb-5">
                        <h2 class="display-7 fw-semibold mb-3">Welcome back! <br> Please <span class="font-caveat text-primary">Sign up</span> to continue.</h2>
                    ...
                    <form class="register-form">
                        <!-- Start Form Group -->
                        <!-- start form group -->
                        <div class="form-group mb-4 profile-pic">
                            <label class="required fw-medium mb-2">Profile Photo</label>
                            <input class="fileUp fileup-sm" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
                            <div class="form-text">Recommended to 350 x 350 px.</div>
                    ...
                    <!-- Start Bottom Text -->
                    <div class="bottom-text mt-4"> Already have an account? <a href="{{('/sign-in')}}" class="fw-medium text-decoration-underline">Sign In</a> </div>
                    <!-- /.End Bottom Text -->
                </div>
            </div>
            <div class="col-xl-7 d-none d-xl-block">
                <div class="background-image bg-light d-flex flex-column h-100 justify-content-center p-5 rounded-4" data-image-src="assets/images/lines.svg">
                    <div class="py-5 text-center">
                        ...
                        <img src="{{asset('front/assets/images/png-img/real-time-analytics.png')}}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
