        ...
        <div class="row g-4 g-xl-5 justify-content-between">
            <div class="col-xl-5 d-flex justify-content-center">
                <div class="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
                    <!-- Start Header Text -->
                    <div class="mb-5">
                        <h2 class="display-7 fw-semibold mb-3">Welcome back! <br> Please <span class="font-caveat text-primary">Sign in</span> to continue.</h2>
                    ...
                    <form class="register-form">
                        ...
                        <!-- Start Button -->
                        <a href="{{('/dashboard')}}">
                            <button type="button" class="btn btn-primary btn-lg w-100">Sign In</button>
                        </a>
                        <!-- End Button -->
                    </form>
            ...
            <div class="col-xl-7 d-none d-xl-block">
                <div class="background-image bg-light d-flex flex-column h-100 justify-content-center p-5 rounded-4" data-image-src="assets/images/lines.svg">
                    <div class="py-5 text-center">
                        ...
                        <img src="{{asset('front/assets/images/png-img/login.png')}}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
