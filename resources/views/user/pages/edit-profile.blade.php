                                ...
                                <div class="row g-4">
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control" placeholder="Name" disabled required="">
                                        </div>
                                        <!-- end /. form group -->
                                    </div>
                                    <div class="col-sm-6 col-lg-4">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="number" class="form-control"  placeholder="(123) 456 - 789" disabled required="">
                                        </div>
                                        <!-- end /. form group -->
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="email" class="form-control" placeholder="example@email.com" disabled required="">
                                        </div>
                                        <!-- end /. form group -->
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="">
                                            ...
                                            <textarea class="form-control" rows="7" disabled placeholder="Please enter up to 4000 characters."></textarea>
                                        </div>
                                        <!-- end /. form group -->
                                    </div>
                                    <div class="col-sm-12">
