                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-sm-6 col-md-6 col-lg-6 d-flex">
                                <div class="card flex-column flex-fill overflow-auto p-4 position-relative shadow w-100 widget-card">
                                    ...
                                    <div class="fs-14 text-muted mb-1">Total Points</div>
                                    <h3 class="mb-0"><span class="counter">5,899</span><span class="fs-13 ms-1 text-muted">(Points)</span></h3>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-6 d-flex">
                                <div class="card flex-column flex-fill overflow-auto p-4 position-relative shadow w-100 widget-card">
                                    <img src="{{asset('front/user/assets/dist/img/corner.png')}}" alt="" class="end-0 h-100 position-absolute top-0">
                                    <div class="fs-14 text-muted mb-1">Equivalent to</div>
                                    <h3 class="mb-0"><span class="counter">1,009</span><span class="fs-13 ms-1 text-muted">(AED)</span></h3>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card overflow-hidden">
                                    <div class="card-header position-relative">
                                        <h6 class="fs-17 fw-semi-bold my-1">Transaction History</h6>
                                    </div>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                ...
                                                                <ul class="fs-14 fw-medium list-inline list-separator mb-0 mt-2">
                                                                    <li class="list-inline-item text-success">AED 99.00</li>
                                                                    <li class="list-inline-item text-primary"><span class="">Points:</span> 21.39</li>
                                                                    ...
                                                                    <li class="list-inline-item text-muted"><span class="text-dark">Date:</span> 05 Aug 2024</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </td>
