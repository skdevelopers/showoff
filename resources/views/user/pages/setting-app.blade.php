          ...
          <div class="container-xxl">
            <div class="card">
              <div class="card-header position-relative">
                <h6 class="fs-17 fw-semi-bold mb-0">Application Setting</h6>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-xl-10 col-xxl-8">
                    <div class="mb-3 row">
                      <label for="applicationTitle" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14 required">Application
                        Title</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input type="text" class="form-control" id="applicationTitle" value="ListOn">
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="address" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Address</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <textarea class="form-control" id="address" rows="3"></textarea>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="emailAddress" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Email
                        Address</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input type="email" class="form-control" id="emailAddress" value="info@ListOn.com">
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="phone" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Phone
                        Number</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                    ...
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Favicon</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input class="fileUp fileup-sm" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
                        <div class="mt-1 text-primary small">Recommended to 32x32 px(jpg, jpeg, png, gif, ico).</div>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Dashboard
                        Logo</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input class="fileUp fileup-sm" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
                        <div class="mt-1 text-primary small">Recommended to 184x42 px(jpg, jpeg, png, gif, ico).</div>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Website
                        Logo</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input class="fileUp fileup-sm" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
                        <div class="mt-1 text-primary small">Recommended to 163x50 px(jpg, jpeg, png, gif, ico).</div>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Header
                        Background Image</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input class="fileUp fileup-sm" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
                        <div class="mt-1 text-primary small">Recommended to 1968x462 px (jpg, png).</div>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Footer
                        Background Image</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input class="fileUp fileup-sm" type="file" name="files" accept=".jpg, .png, image/jpeg, image/png" multiple>
                        <div class="mt-1 text-primary small">Recommended to 1968x462 px (jpg, png).</div>
                    ...
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Language</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                    ...
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14 required">Time
                        Zone</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <select class="form-select" aria-label="Default select example">
                    ...
                    <div class="mb-3 row">
                      <label class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Admin
                        Align</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <select class="form-select" aria-label="Default select example">
                    ...
                    <div class="mb-3 row">
                      <label for="officeTime" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Office
                        Time</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <textarea class="form-control" id="officeTime" rows="3"></textarea>
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="location" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Latitude,
                        Longitude</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input type="email" class="form-control" id="location" value="40.6700, -73.9400">
                      </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="footer" class="col-sm-4 col-md-12 col-lg-3 text-start text-sm-end text-md-start text-lg-end col-form-label fw-medium fs-14">Footer
                        Text</label>
                      <div class="col-sm-8 col-md-12 col-lg-9 col-xl-7">
                        <input type="text" class="form-control" id="footer" value="2022 © Copyright ListOn Ltd.">
                      </div>
                    </div>
                    <div class="row mt-4">
                      <div class="col-sm-12 text-center">
                        <button type="button" class="btn btn-primary fw-semi-bold">Reset</button>
                        <button type="button" class="btn btn-primary fw-semi-bold ms-1">Save</button>
                      </div>
                    </div>
                  </div>
                </div>
