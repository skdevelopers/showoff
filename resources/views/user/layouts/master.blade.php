...
<head>
    ...
    <title>Show Off - Directory & Listing </title>
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('front/assets/images/favicon.png')}}">
    <!-- Global Styles(used by all pages) -->
    <link href="{{asset('')}}front/user/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="{{asset('front/user/assets/plugins/metisMenu/metisMenu.min.css')}}" rel="stylesheet">
    <link href="{{asset('front/user/assets/plugins/fontawesome/css/all.min.css')}}" rel="stylesheet">
    <!-- Third party Styles(used by this page) -->
    <link href="{{asset('')}}front/user/assets/plugins/toastr/toastr.css" rel="stylesheet">
    <link href="{{asset('front/user/assets/plugins/datatables/dataTables.bootstrap5.min.css')}}" rel="stylesheet">
    <!-- App css -->
    <link href="{{asset('front/user/assets/dist/css/app.min.css')}}" rel="stylesheet">
    <!-- Start Your Custom Style Now -->
    <link href="{{asset('front/user/assets/dist/css/style.css')}}" rel="stylesheet">
</head>
...
<body class="fixed sidebar-mini">
    ...
    <!-- <div class="page-loader page-loader-active">
        <div class="page-loader-content">
            <div class="page-loader-logo">
                <img src="{{asset('front/user/assets/dist/img/SHOWOFF-UNLIMITED-BLACK.png')}}" alt="Logo">
            </div>
        ...
        <nav class="sidebar">
            <div class="sidebar-header">
                <a href="{{('/dashboard')}}" class="sidebar-brand">
                    <img class="sidebar-brand_icon" src="{{asset('front/user/assets/dist/img/SHOWOFF-UNLIMITED-BLACK.png')}}" alt="">
                    <span class="sidebar-brand_text">SHOWOFF</span></span>
                </a>
            </div>
            <!--/.sidebar header-->
                    ...
                    <ul class="metismenu">
                        ...
                        <li>
                            <a href="{{('/service-history')}}">
                                ...
                                <span class="ms-2">Service History</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{('/loyality')}}">
                        ...
                        <li>
                            <a href="{{('/change-password')}}">
                                <svg fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" id="icon"
                            ...
                            <li class="nav-item dropdown user-menu user-menu-custom">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="edit-{{('profile')}}" class="dropdown-item">
                                        ...
                                        Edit Profile</a>
                                    <a href="{{('/service-history')}}" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-6 col-md-4 d-flex">
                                <div style="background: #493a52;"
                                    ...
                                    <img class="qr-wrapper-img"
                                        src="{{asset('front/user/assets/dist/img/9c1d35fa59da3240835207db61b9998a.svg')}}" alt=""
                                        width="180">
                                ...
                                <div class="card flex-column flex-fill p-4 position-relative shadow w-100 widget-card">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <img src="{{asset('front/user/assets/dist/img/graph-v1.png')}}" alt="img">
                                        </div>
                                    </div>
                                </div>
                            </div> -->
    ...
    <script src="{{asset('front/user/assets/plugins/jQuery/jquery.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/metisMenu/metisMenu.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
    <!-- Third Party Scripts(used by this page) -->
    <script src="{{asset('front/user/assets/plugins/toastr/toastr.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/datatables/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/datatables/dataTables.bootstrap5.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/jquery.counterup/jquery.waypoints.min.js')}}"></script>
    <script src="{{asset('front/user/assets/plugins/jquery.counterup/jquery.counterup.min.js')}}"></script>
    <!-- Page Scripts(used by all page) -->
    <script src="{{asset('front/user/assets/dist/js/app.min.js')}}"></script>
    <!-- Page Active Scripts(used by this page) -->
    <script src="{{asset('front/user/assets/dist/js/dashboard.js')}}"></script>
</body>
