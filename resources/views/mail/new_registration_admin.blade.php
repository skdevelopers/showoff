                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <img src="{{ asset('') }}admin-assets/assets/img/new-logo.png" alt="" style="max-width: 120px; margin-bottom: 0px; ">
                                                                ...
                                                                <h1 style="color: #252525; font-size: 25px; line-height: 26px; margin:20px 0 0 0;">New User Registration - Pending Approval
                                                                </h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                                        ...
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                                                <h4 style="font-size: 16px;">Hi admin,</h4>
                                                                                  <p style="margin:0;padding:0;margin-bottom:5px;color:#000;font-weight:400;font-size:13px;line-height:1.6">A new user has been registered on Deals Drive and is currently waiting for approval. Below are the details:
</p>
                                                                                ...
                                                                                <h4 style="font-size: 14px;">Registration Date : <span>{{web_date_in_timezone($user->created_at,'d-M-Y h:i A')}}</span></h4>
                                                                                
                                                                              
<p style="margin:0;padding:0;margin-bottom:5px;color:#000;font-weight:400;font-size:13px;line-height:1.6">Please review the information provided and take appropriate action to approve or deny the registration.
</p>
