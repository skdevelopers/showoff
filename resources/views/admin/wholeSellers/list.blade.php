...
@section("content")
    ...
    <div class="card mb-5">
        @if(check_permission('wholeSellers','Create'))
            <div class="card-header"><a href="{{url('admin/wholeSellers/create')}}"
                            ...
                            <td class="text-center">
                                <div class="dropdown custom-dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                        @if(check_permission('wholeSellers','Edit'))
                                            <a class="dropdown-item"
                                               href="{{url('admin/wholeSellers/'.$datarow->id.'/edit')}}"><i
                                                        class="flaticon-pencil-1"></i> Edit</a>
                                        @endif

                                        @if(check_permission('wholeSellers','ChangePassword'))
                                        ...
                                        @if(check_permission('pictures','View'))
                                            <a class="dropdown-item"
                                               href="{{url('admin/wholesaler/orders?vendor='.$datarow->id)}}">
                                                <i class="flaticon-plus"></i> View Orders</a>
                                        @endif
                                        @if(check_permission('videos','View'))
                                            <a class="dropdown-item"
                                        ...
                                        @endif
                                        @if(check_permission('wholeSellers','Delete'))
                                            <a class="dropdown-item" data-role="unlink"
                                               data-message="Do you want to remove this Vendor?"
                                               href="{{ url('admin/wholeSellers/' . $datarow->id) }}"><i
