                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select name="outlet_id" class="form-control" required
                            ...
                            @foreach ($outlets as $data)
                                <option catid="{{ $data->main_category_id }}" value="{{ $data->id }}"
                                    @if (!empty($datamain->outlet_id)) {{ $datamain->outlet_id == $data->id ? 'selected' : null }} @endif>
                                    {{ $data->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div id="discountfield">
                     ...
                     <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="coupon_usage_peruser" oninput="validateNumber(this);" class="form-control" maxlength="5"
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control flatpickr-input"
                            ...
                            required data-parsley-required-message="Select Start date" data-parsley-daterangevalidation data-parsley-daterangevalidation-requirement="#date_input_2">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control flatpickr-input" id="date_input_2"
                            name="expirydate"
                    ...
                    <div class="col-md-6 form-group" style="display:none;">
                        ...
                        <input type="text" name="minimum_amount" oninput="validateNumber(this);" class="form-control" maxlength="5"
                            value="{{ empty($datamain->minimum_amount) ? '' : $datamain->minimum_amount }}" data-parsley-type="number">
                    </div>
                   
                    <div class="col-md-6 form-group">
                        <label>Usage limit per coupon</label>
                        <input type="text" name="coupon_usage_percoupon" oninput="validateNumber(this);" class="form-control" maxlength="5"
                    ...
                    <div class="col-sm-6 col-xs-12">
                            <div class="form-group d-flex align-items-center">
                                <div>
                                    <label>Upload  Policies (gif,jpg,png,jpeg,pdf) @if(!isset($datamain))<span
                                    ...
                                    <input type="file" class="form-control jqv-input" name="policy" data-role="file-image"
                                        ...
                                        data-parsley-fileextension-message="Only files with type jpg,png,gif,jpeg,pdf are supported" data-parsley-max-file-size="5120" data-parsley-max-file-size-message="Max file size should be 5MB" >
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="form-group d-flex align-items-center">                                
                                <label>Voucher Unlock Videos<span
                                ...
                                <select name="videos[]" class="form-control select2" id="videos" @if(empty($datamain->coupon_id)) required @endif multiple>
                       ...
                       <div class="col-md-12 form-group  imgs-wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 mb-3 img-wrap">
                                    <span class="close" title="Delete" data-role="unlink" style="position: absolute; right: 15px; top: 0px; z-index: 1; background: red; width: 40px; height: 40px; opacity: 1; display: flex; align-items: center; justify-content: center; color: #fff; border-radius: 5px;"
                                        data-message="Do you want to remove this image?"
                                        href="{{ url('admin/coupons/delete_image/' . $img->id) }}">&times;</span>
                                    <img style="height: 150px; object-fit:cover" class="img-fluid w-100" src="{{ asset('storage/coupons/'.$img->coupon_banner) }}">
...
$(document).ready(function() {
  $.fn.parsley.addValidator('greaterThanCouponPrice', function(value, element) {
    var couponPrice = parseFloat($($('input[name="coupon_price"]')).val());
    return parseFloat(value) < couponPrice;
  });
