                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/services/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    
                                  
                                    @if(check_permission('services','Delete'))
                                    {{-- <a class="dropdown-item" data-role="unlink"
                                    data-message="Do you want to remove this Service?"
                                    href="{{ url('admin/services/' . $datarow->id) }}"><i
