...
<style>
    ...
    <div class="mb-5">
                <!--<div class="card p-4">-->
                    <form method="post" id="admin-form" action="{{ url('admin/store_managers') }}" enctype="multipart/form-data"
                    ...
                    <div class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="form-group d-flex align-items-center">
                                            ...
                                            <input type="file" class="form-control jqv-input" name="image" data-role="file-image" data-parsley-imagedimensions="400x400" data-parsley-trigger="change" data-preview="image-preview" @if(empty($id)) required
                        ...
                        data-parsley-required-message="Select Country" data-role="country-change" id="country" data-input-state="city-state-id">
                            ...
                            @endforeach;
                                     ...
                                     <div class="col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label>Privilege Type<span style="color:red;">*<span></span></span></label>
                                            
                                                <select name="previllegetype" class="form-control jqv-input" data-jqv-required="true"
                                                required
                            data-parsley-required-message="Select Privilege Type" >

                                                    <option value="">Select</option>
                            @foreach ($managertype as $cnt)
                                <option  value="{{ $cnt->id }}" @if(!empty($vendor)) {{$datamain->previllege==$cnt->id ? "selected" : null}} @endif>
                                    {{ $cnt->name }}</option>
                            @endforeach;
                                                </select>
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label>Vendor<span style="color:red;">*<span></span></span></label>
                                                ...
                                                <select name="vendor" class="form-control jqv-input" data-jqv-required="true"
                                                required
                            data-parsley-required-message="Select Vendor" data-role="vendor-change" data-input-store="store-id">

                                                    <option value="">Select</option>
                            @foreach ($vendors as $cnt)
                                <option  value="{{ $cnt->id }}" @if(!empty($vendor)) {{$datamain->vendor==$cnt->id ? "selected" : null}} @endif>
                                    {{ $cnt->name }}</option>
                            @endforeach;
                                                </select>
                                    ...
                                    <div class="col-md-4 col-xs-12 form-group">
                                        ...
                                        <select class="form-control jqv-input select2" name="store_id" required
                                            ...
                                            @foreach ($stores as $sel)
                                                <option value="{{$sel->id }}" @if ($sel->id == $datamain->store) selected @endif>{{ $sel->store_name }}
                                                </option>
                                            @endforeach
                            ...
                            <div class="card-body card mb-2">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <h6 class="text-xl mb-2">Manager Address</h6>
                                        <!--<div class="col-sm-12">-->
                                            <div class="row">
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/admin/store_managers');
                        }, 1500);
                    }
