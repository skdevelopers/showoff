...
@section('content')
    <div class="card mb-5">
        ...
        <div class="card-body">
            <form method="post" action="{{ url('/admin/faq/create') }}" id="admin-form" enctype="multipart/form-data" data-parsley-validate="true">
                @csrf
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/admin/faq');
                        }, 1500);
                    }
