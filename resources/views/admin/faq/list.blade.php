...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/faq/create')}}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create FAQ</a></div>
    @endif
    <div class="card-body">
                   ...
                   <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    <a class="dropdown-item" data-role="unlink" data-message="Do you want to remove this faq?" href="{{url('admin/faq/delete/'.$item->id)}}"><i class="flaticon-delete-1"></i> Delete</a>
                                    @endif
                                </div>
                            </div>
                        </td>
