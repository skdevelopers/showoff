                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    ...
                                    @endif
                                    <a class="dropdown-item" href="{{url('admin/coupon_usage/?user_id='.$datarow->id)}}"><i class="flaticon-pencil-1"></i> Coupon Usage</a>
                                    
                                    
                                    @if(check_permission('customers','ChangePassword'))
                                    <a class="dropdown-item" userid="{{$datarow->id}}" data-role="change_password" ><i class="flaticon-plus"></i> Change Password</a>
                                    @endif
                                   
                                    @if(check_permission('customers','Delete'))
