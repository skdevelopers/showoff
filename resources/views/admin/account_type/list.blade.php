...
@section('content')
    <div class="card mb-5">
        ...
        <div class="card-header">
            <a href="{{ url('admin/account_type/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Account Type</a>
            <a href="{{ url('admin/account_type/sort') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-arrow-up-wide-short"></i> Sort</a>
        </div>
        @endif
        <div class="card-body">
                                ...
                                <td class="text-center">
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                            ...
                                            @endif 
                                            @if(check_permission('account_type','Delete'))
