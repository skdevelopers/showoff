...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ url('admin/brand/create') }}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Brand</a>
            @endif
