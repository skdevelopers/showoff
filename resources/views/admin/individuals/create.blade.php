...
<div class="mb-5">
    ...
    <form method="post" id="admin-form" action="{{ url('admin/individuals') }}" enctype="multipart/form-data"
        ...
        <div class="">
            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-body card-title">Fill Your Basic Info</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-jqv-maxlength="7" name="name"
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label>Residence No<b class="text-danger">*</b></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <select class="form-control" name="res_dial_code" required
                                            data-parsley-required-message="">
                                            <option value="">code</option>
                                            @foreach ($countries as $cnt)
                                            <option @if($id) @if($datamain->res_dial_code==$cnt->dial_code) selected
                                                @endif @endif value="{{ $cnt->dial_code }}">+{{ $cnt->dial_code }}
                                            </option>
                                            @endforeach;
                                        </select>
                                    </div>
                                    <input type="number" class="form-control" name="res_phone"
                                        value="{{empty($datamain->res_phone) ? '': $datamain->res_phone}}"
                                        data-jqv-required="true" required
                                        data-parsley-required-message="Enter Phone number" data-parsley-type="digits"
                                        data-parsley-minlength="5" data-parsley-maxlength="7"
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label>Email Address<span style="color:red;">*<span></span></span></label>
                                <input type="email" class="form-control" name="email" data-jqv-maxlength="50"
                                    value="{{empty($datamain->email) ? '': $datamain->email}}"
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-body card-title">Bank Account Details</h5>
                ...
                <div class="row card-body">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <div class="form-group d-flex align-items-center">
                            <div>
                                <label>Upload Profile Picture (gif,jpg,png,jpeg) <span
                                        style="color:red;">*<span></span></span></label>
                                <input type="file" class="form-control jqv-input" name="user_image"
                                    data-role="file-image" data-preview="user_image-preview" value="" @if(empty($id))
                                    required data-parsley-required-message="image is required" @endif
                                    data-parsley-imagedimensions="200x200" data-parsley-trigger="change">
                                <p class="text-muted mt-2">Allowed Dim 200x200(px)</p>
                            </div>
                            <img id="user_image-preview" class="img-thumbnail w-50"
                                style="margin-left: 5px; height:75px; width:75px !important;"
                                src="{{empty($datamain->user_image) ? asset('uploads/company/17395e3aa87745c8b488cf2d722d824c.jpg'): $datamain->user_image}}">
                        </div>
                    </div>
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (res['status'] == 0) {
                ...
                setTimeout(function() {
                    window.location.href = App.siteUrl('/admin/individuals');
                }, 1500);
            }
