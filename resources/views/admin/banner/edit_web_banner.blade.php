...
@section('content')
    <div class="card mb-5">
        ...
        <div class="card-body">
            <form method="post" action="{{ url('/admin/web_banner/update') }}" id="admin-form" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$banner->id}}">
                <div class="row  d-flex justify-content-between align-items-center">
                    <div class="col-md-6 form-group">
                        <label>Title 1</label>
                        <input type="text" name="banner_title_1" class="form-control jqv-input" value="{{$banner->banner_title_1}}">
                    </div>

                    <div class="col-md-6 form-group">
                        <label>Title 2</label>
                        <input type="text" name="banner_title_2" class="form-control jqv-input" value="{{$banner->banner_title_2}}">
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Title 3</label>
                        <input type="text" name="banner_title_3" class="form-control jqv-input" value="{{$banner->banner_title_3}}">
                    </div>
                    <div class="col-md-6 form-group">
                        <label>Title 4</label>
                        <input type="text" name="banner_title_4" class="form-control jqv-input" value="{{$banner->banner_title_4}}">
                    </div>
                    ...
                    <div class="col-md-12 form-group" >
                        <img id="image-preview" style="width:300px; height:168px;" class="img-responsive mb-1"  data-image="{{get_uploaded_image_url($banner->banner_image,'banner_image_upload_dir')}}" src="{{get_uploaded_image_url($banner->banner_image,'banner_image_upload_dir')}}">
                    </div>
                    <input type="hidden" id="cropped_upload_image" name="cropped_upload_image">
                    <div class="col-md-6 form-group">
                        <label>Upload Banner</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input jqv-input crop_image" onclick="this.value=null;" data-cropped-image-preview="image-preview" data-aspect-ratio="1.78" data-cropped-image-input="cropped_upload_image" name="banner"
                                data-role="file-image" data-jqv-required="true" id="banner">
