...
@section('content')
    <div class="card mb-5">
        ...
        <div class="card-header">
            ...
            <a href="{{ url('admin/store/sort') }}" class="btn btn-warning mt-2 mb-2 mr-2 btn-rounded">Sort</a>
        </div>
        @endif
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($stores as $str)
                            ...
                            <tr>
                                ...
                                <td>@if(isset($str->vendor->name)) {{ $str->vendor->name }} @endif</td>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ url('admin/products?store='.$str->id) }}"><i
                                                    ...
                                                    @endif
                                            @if(check_permission('stores','Delete'))    
