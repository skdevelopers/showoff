...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ url('admin/save_table') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <label>Table Name<b class="text-danger">*</b></label>
                            <input type="text" name="name" class="form-control" required
                                data-parsley-required-message="Enter Table Name" value="{{ $name }}">
                        </div>
                    </div>
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        App.alert(res['message'], 'Success!');
                                setTimeout(function(){
                                    window.location.href = App.siteUrl('/admin/table');
                                },1500);
