...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/coach/create')}}" class="btn-custom btn mr-2 mt-2 mb-2"><i class="fa-solid fa-plus"></i> Create Coach</a></div>
    @endif
    <div class="card-body">
                        ...
                        <td>
                            <label class="switch s-icons s-outline  s-outline-warning mb-2 mt-2 mr-2">
                                        <input type="checkbox" class="change_status" data-id="{{ $datarow->id }}"
                                            data-url="{{ url('admin/coach/change_status') }}"
                        ...
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    @if(check_permission('coach','Edit'))
                                    <a class="dropdown-item" href="{{url('admin/coach/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    
                                   <!--  @if(check_permission('coach','ChangePassword'))
                                    <a class="dropdown-item" userid="{{$datarow->id}}" data-role="change_password" ><i class="flaticon-plus"></i> Change Password</a>
                                    @endif -->
                                   
                                    @if(check_permission('coach','Delete'))
                                    <a class="dropdown-item" data-role="unlink"
                                    data-message="Do you want to remove this Customer?"
                                    href="{{ url('admin/coach/' . $datarow->id) }}"><i
