...
class StoreController extends Controller
{
    ...
    public function index()
    {
        //
        $vendor = auth()->user()->id;
        if(auth()->user()->role == 4) //store manager
        {
            $vendor = auth()->user()->vendor;
        }
        $page_heading = "Stores";
        $stores = Stores::where(['deleted' => 0,
            'vendor_id' => $vendor])->get();
        return view('vendor.store.list', compact('page_heading', 'stores'));
    }
    ...
    public function create()
    {
        ...
        $states = [];
        $cities = [];
        return view("vendor.store.create", compact('page_heading', 'mode', 'id', 'industry_types', 'countries', 'vendors','states','cities'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($store) {
            ...
            return view("vendor.store.create", compact('page_heading', 'mode', 'id', 'industry_types', 'countries', 'vendors', 'store', 'images','states','cities'));
        } else {
            abort(404);
        }
    }
